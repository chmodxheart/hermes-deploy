...
| Kubernetes/Talos | Current external Kubernetes/Talos source | Phase 3 defines the in-repo representation and integration method. | `ownership-boundary.md` |
...
6. Use `../nixos/docs/ops/phase-01-verification.md` for live verification of the current audit-plane stack.
